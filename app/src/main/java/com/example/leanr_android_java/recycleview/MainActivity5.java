    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClick(new StudentAdapter.OnItemClick() {
            ...
            public void clickItem() {
                Toast.makeText(MainActivity5.this,"day la item",Toast.LENGTH_SHORT).show();
            }
        });
        fabCreate.setOnClickListener(v->{
            studentList.add(10,new Student("Duong moi",20,"1","PT"));
            adapter.notifyItemInserted(10);
            //thong bao toan bo danh sach thay doi
